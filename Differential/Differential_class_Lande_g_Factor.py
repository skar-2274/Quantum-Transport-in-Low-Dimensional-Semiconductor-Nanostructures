...
class Equations:
    ...
    def Tf(self, n, x): #Forward Transmission
        ...
        tf = (0.5*B*(0.5)*mu_B*exp((-B*(0.5)*g*mu_B + E_2*(n + 0.5) - 0.5*V_sd*e - hbar*x*w_x)/E_1)
        /(E_1*(exp((-B*(0.5)*g*mu_B + E_2*(n + 0.5) - 0.5*V_sd*e - hbar*x*w_x)/E_1) + 1)**2)
        + 0.5*B*(-0.5)*mu_B*exp((-B*(-0.5)*g*mu_B + E_2*(n + 0.5) - 0.5*V_sd*e - hbar*x*w_x)/E_1)
        /(E_1*(exp((-B*(-0.5)*g*mu_B + E_2*(n + 0.5) - 0.5*V_sd*e - hbar*x*w_x)/E_1) + 1)**2))
    ...
    def Tb(self, n, x): #Backward Transmission
        ...
        tb = (0.5*B*(0.5)*mu_B*exp((-B*(0.5)*g*mu_B + E_2*(n + 0.5) + 0.5*V_sd*e - hbar*x*w_x)/E_1)
        /(E_1*(exp((-B*(0.5)*g*mu_B + E_2*(n + 0.5) + 0.5*V_sd*e - hbar*x*w_x)/E_1) + 1)**2)
        + 0.5*B*(-0.5)*mu_B*exp((-B*(-0.5)*g*mu_B + E_2*(n + 0.5) + 0.5*V_sd*e - hbar*x*w_x)/E_1)
        /(E_1*(exp((-B*(-0.5)*g*mu_B + E_2*(n + 0.5) + 0.5*V_sd*e - hbar*x*w_x)/E_1) + 1)**2))
